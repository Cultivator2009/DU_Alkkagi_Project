...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string ko, string en)> Table = new Dictionary<string, (string ko, string en)>
    {
        ...
        { "hud.skipped", ("{0}이 턴을 넘겼어요", "{0} skipped the turn") },

        { "placement.title", ("돌 배치", "Place stones") },
        { "placement.hint", ("내 진영을 눌러 돌을 놓으세요\n남은 돌 {0}개", "Click inside your zone\n{0} left to place") },
        { "placement.hintMove", ("돌을 끌어 옮길 수 있어요", "Drag a stone to move it") },
        { "placement.hintDone", ("모두 놓았어요", "All stones placed") },
        ...
        { "placement.timeoutNote", ("시간이 끝나면 남은 돌은 무작위로 놓여요", "Time up places the rest at random") },
        ...
        { "reason.bothOutWin", ("마지막 돌이 함께 떨어져 쏜 {0}이 이겼어요", "Both last stones went out, so {0} wins for shooting") },
        { "reason.bothOutDraw", ("마지막 돌이 함께 떨어져 무승부예요", "Both last stones went out: a draw") },
        ...
        { "match.blackStones", ("흑 돌 개수", "Black stones") },
        { "match.whiteStones", ("백 돌 개수", "White stones") },
        { "match.spawn", ("돌 배치", "Stone setup") },
