...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string ko, string en)> Table = new Dictionary<string, (string ko, string en)>
    {
        ...
        { "reason.bothOut", ("마지막 알이 함께 떨어져 쏜 {0}이 졌어요", "Both last pieces went out, so {0} loses for shooting") },
        { "reason.bothOutWin", ("마지막 알이 함께 떨어져 쏜 {0}이 이겼어요", "Both last pieces went out, so {0} wins for shooting") },
