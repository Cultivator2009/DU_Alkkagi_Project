...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string ko, string en)> Table = new Dictionary<string, (string ko, string en)>
    {
        ...
        // The third and fourth sides of an online game of three or four.
        { "player.blue", ("청", "Blue") },
        { "player.red", ("적", "Red") },
        ...
        { "hud.menu", ("메뉴", "Menu") },
        { "hud.out.Knockout", ("탈락", "Out") },
        { "hud.out.Surrender", ("기권", "Conceded") },
        { "hud.out.OpponentLeft", ("나감", "Left") },
        { "hud.outNotice.Knockout", ("{0} 탈락", "{0} is out") },
        ...
        { "placement.othersReady", ("{0}/{1}명 준비 완료", "{0}/{1} ready") },
        ...
        { "reason.lastStanding", ("{0}만 끝까지 남았어요", "{0} was the last one standing") },
        { "reason.othersGone", ("다른 쪽이 모두 기권하거나 나갔어요", "Everyone else conceded or left") },
        { "reason.hostLeft", ("호스트가 게임을 나가 대전이 끝났어요", "The host left, so the match is over") },
        { "result.over", ("대전 종료", "Match over") },
        { "result.stampOver", ("끝", "End") },
        { "stats.kills", ("킬", "Kills") },
        ...
        { "menu.ranking", ("랭킹", "Rankings") },
        { "menu.quit", ("종료", "Quit") },
        { "menu.steamUser", ("Steam · {0} · 레이팅 {1}", "Steam · {0} · Rating {1}") },

        // The rankings card (LeaderboardPanel): the Steam leaderboard of ratings.
        { "rank.title", ("랭킹", "Rankings") },
        { "rank.scope.top", ("전체", "Top") },
        { "rank.scope.around", ("내 주변", "Around me") },
        { "rank.scope.friends", ("친구", "Friends") },
        { "rank.place", ("순위", "Rank") },
        { "rank.name", ("이름", "Name") },
        { "rank.rating", ("레이팅", "Rating") },
        { "rank.recordHeader", ("전적", "Record") },
        { "rank.record", ("{0}승 {1}패", "{0}W {1}L") },
        { "rank.recordDraws", ("{0}승 {1}패 {2}무", "{0}W {1}L {2}D") },
        { "rank.summary", ("내 레이팅 {0} · {1}", "Your rating {0} · {1}") },
        { "rank.summaryPlace", (" · {0}위", " · #{0}") },
        { "rank.noGames", ("아직 랭크전 기록이 없어요", "No ranked matches yet") },
        { "rank.loading", ("불러오는 중…", "Loading…") },
        { "rank.empty", ("아직 기록이 없어요", "No one here yet") },
        { "rank.offline", ("Steam에 연결되어 있지 않아요", "Not connected to Steam") },
        { "rank.failed", ("순위를 불러오지 못했어요", "Couldn't load the rankings") },
        { "rank.caption", ("온라인 랭크전 결과로 오르내려요 · 시작 레이팅 1000", "Online ranked matches move it · everyone starts at 1000") },
        ...
        { "settings.display", ("화면", "Display") },
        { "settings.windowMode", ("화면 모드", "Window mode") },
        { "settings.fullscreen", ("전체 화면", "Fullscreen") },
        { "settings.windowed", ("창 모드", "Windowed") },
        { "settings.windowSize", ("창 크기", "Window size") },
        { "settings.sizeValue", ("{0} × {1}", "{0} × {1}") },
        ...
        { "bind.PanView", ("시점 이동 (누르고 끌기)", "Pan view (hold and drag)") },
        { "bind.ResetView", ("시점 초기화", "Reset view") },
        ...
        { "match.mode", ("모드", "Mode") },
        // Normal (and Item, later) are rated, with the balance rules fixed; Custom opens them all.
        { "mode.Normal", ("일반전", "Normal") },
        { "mode.Item", ("아이템전", "Items") },
        { "mode.Custom", ("커스텀", "Custom") },
        { "match.board", ("판", "Board") },
        ...
        { "match.blueStones", ("청 알 개수", "Blue pieces") },
        { "match.redStones", ("적·흑 알 개수", "Red/Black pieces") },
        ...
        { "lobby.rowRules", ("{0} · {1} · {2} · {3}/{4}명", "{0} · {1} · {2} · {3}/{4}") },
        ...
        { "lobby.rulesRanked", ("일반전 · 레이팅 반영 · 흐린 규칙은 고정", "Normal · rated · dimmed rules are fixed") },
        { "lobby.rulesCustom", ("커스텀 · 모든 규칙 변경 가능 · 레이팅 미반영", "Custom · every rule open · not rated") },
